   ...
   const retrieveAutoFee = ()=>{
    ...
    const getbalance = (_id)=>{
        ...
        .then((res)=>{
            if(Balance !== res.data.naira_wallet[0].balance.$numberDecimal ){
                setBalance(parseFloat(res.data.usdt_wallet[0].balance.$numberDecimal));
    ...
    const getRate = async()=>{
        ...
        .then((res)=>{
            ...
            setsellrate(res.data.message[0].usdt[0].sell);
                ...
                <div className='SendBodyI'>
                    ...
                    <div className='fromBTC'>
                        ...
                        <div>
                            ...
                            Balance:&nbsp;{Balance && Balance.toLocaleString('en-US')} USDT
                        </div>
                    </div>
                    {/* <div className='toBTC'>
